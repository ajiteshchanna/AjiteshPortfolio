  ...
  return (
    ...
    >
      ...
      {/* Center emblem — stable, non-rotating */}
        <div
        className="relative z-10 flex h-[42px] w-[42px] items-center justify-center rounded-full border border-accent/35 bg-background shadow-[0_0_18px_-4px_rgba(223,37,49,0.4)]"
        aria-hidden="true"
      >
